...
var Hue = function () {
    ...
    _createClass(Hue, [{
        ...
        value: function start() {
            //Get all lights and create lwm2m-objects //TODO support multiple door locks
            var that = this;

            return new Promise(function (resolve, reject) {
                var obj = "/" + _lwm2mMapping2.default.getAttrId("lock").objectTypeId + "/" + 0;

                _Util2.default.createClientObject(that._lwm2m, obj).catch(function (error) {
                    reject(error);
                }).then(function () {
                    _Util2.default.setClientResource(that._lwm2m, obj, _lwm2mMapping2.default.getAttrId("lock", "locked").resourceTypeId, false) //Default locked, todo: configurable
        ...
        value: function _initObjects(lights) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                async.each(Object.keys(lights), function (id, callback) {
